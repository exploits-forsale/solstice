...
use windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWP_DATA_TYPE;
use windows::Win32::NetworkManagement::WindowsFilteringPlatform::FWP_DATA_TYPE_MAX;
