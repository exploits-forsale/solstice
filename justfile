...
generate:
    ...
    xcopy /y shellcode_stage2\\target\\x86_64-pc-windows-msvc\\release\\shellcode_stage2.bin %LOCALAPPDATA%\Packages\27878ConstantineTarasenko.458004FD2C47C_c8b3w9r5va522\LocalState\stage2.bin
    xcopy /y test_program\\target\\release\\test_program.exe %LOCALAPPDATA%\Packages\27878ConstantineTarasenko.458004FD2C47C_c8b3w9r5va522\LocalState
